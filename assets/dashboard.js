        ...
        async function refreshData() {
            ...
            // Update UI
            updateTrafficSection(results); //1.
            updateBandwidthSection(results); //2.
            updateOriginPullSection(results); //3.
            updateRequestsSection(results); //4.
            updatePerformanceSection(results); //5.
            updateEdgeFunctionsSection(results); // New
            updateSecuritySection(results); //5.1
            updateTopAnalysisSection(results); //6.
        }
